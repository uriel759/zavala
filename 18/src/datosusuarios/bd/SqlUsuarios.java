...
public class SqlUsuarios extends Conexion {
    ...
    public boolean login(Usuarios usr) {
        ...
        String sql = "SELECT u.id, u.usuario, u.password, u.nombre, u.id_tipo, t.nombre  FROM usuarios AS u INNER JOIN tipo_usuario AS t  ON u.id_tipo = t.id WHERE usuario = ? LIMIT 1";
